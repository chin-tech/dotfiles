...
#let code-highlight=(
    active_guide: "#fab38780", 
    background: "#1e1e2e", 
    bracket_contents_foreground: "#9399b280", 
    bracket_contents_options: "underline", 
    brackets_foreground: "#9399b280", 
    brackets_options: "underline", 
    caret: "#bac2de", 
    find_highlight: "#f9e2af", 
    find_highlight_foreground: "#181825", 
    foreground: "#cdd6f4", 
    gutter_foreground: "#9399b2", 
    gutter_foreground_highlight: "#a6e3a1", 
    invisibles: "#9399b266", 
    line_highlight: "#cdd6f412", 
    selection: "#7f849c66", 
    selection_border: "#1e1e2e", 
...
#let globals=(
    ...
    codeblock: (
        ...
        size: 11pt,
        theme: ( path: "themes/catppuccin-mocha.tmTheme")
    ),
    math: (
        // typst built-in math font, New Computer Modern Math
