...
#let code-highlight=(
    active_guide: "#fe640b80", 
    background: "#eff1f5", 
    bracket_contents_foreground: "#7c7f9380", 
    bracket_contents_options: "underline", 
    brackets_foreground: "#7c7f9380", 
    brackets_options: "underline", 
    caret: "#5c5f77", 
    find_highlight: "#df8e1d", 
    find_highlight_foreground: "#e6e9ef", 
    foreground: "#4c4f69", 
    gutter_foreground: "#7c7f93", 
    gutter_foreground_highlight: "#40a02b", 
    invisibles: "#7c7f9366", 
    line_highlight: "#4c4f6912", 
    selection: "#8c8fa166", 
    selection_border: "#eff1f5", 
...
#let globals=(
    ...
    codeblock: (
        ...
        size: 12em/14,
        theme: ( path: "themes/catppuccin-latte.tmTheme")
    ),
    math: (
        // typst built-in math font, New Computer Modern Math
