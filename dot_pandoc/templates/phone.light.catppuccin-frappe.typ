...
#let code-highlight=(
    active_guide: "#ef9f7680", 
    background: "#303446", 
    bracket_contents_foreground: "#949cbb80", 
    bracket_contents_options: "underline", 
    brackets_foreground: "#949cbb80", 
    brackets_options: "underline", 
    caret: "#b5bfe2", 
    find_highlight: "#e5c890", 
    find_highlight_foreground: "#292c3c", 
    foreground: "#c6d0f5", 
    gutter_foreground: "#949cbb", 
    gutter_foreground_highlight: "#a6d189", 
    invisibles: "#949cbb66", 
    line_highlight: "#c6d0f512", 
    selection: "#838ba766", 
    selection_border: "#303446", 
...
#let globals=(
    ...
    codeblock: (
        ...
        size: 12em/14,
        theme: ( path: "themes/catppuccin-frappe.tmTheme")
    ),
    math: (
        // typst built-in math font, New Computer Modern Math
...
#let horizontalrule = [
  ...
  #block(spacing: 1em, inset: (5pt))[
    // #v(1pt)
    #line(start: ( 2 * 14pt,0%), end: (100%,0%), stroke: 1pt + rgb("#5c6166"))
    // #v(1pt) 
  ]
...
#show heading: set text(fill: rgb("#ffaa33") )
#show heading: it => {
...
#set footnote.entry(
    indent: 0em,
    gap: 10pt,
    separator: line(length: 30%, stroke:0.5pt + rgb("#5c6166")),
)
